...
\usepackage{titlesec}
\usepackage{amsmath}
\usepackage{xparse}									% NewDocumentCommand 把begin/end env變成一行, https://tex.stackexchange.com/questions/223684/abridging-begin-end
...
\lstdefinelanguage{vim} % https://tex.stackexchange.com/a/392185
{
% list of keywords
morekeywords={
set, let
...
% \def\isHideManuals{1} % uncomment this line to hide manuals

\NewDocumentCommand{\manuallisting}{m}{
  \ifx\isHideManuals\undefined
    \begin{obeylines}
      \parindent=0pt
      \input{#1}
    \end{obeylines}
...
\fancyhead[L]{National Taiwan Ocean University daidaiclub}
\fancyhead[R]{\thepage}
...
\subsection{.vimrc}
\manuallisting{basic/vimrc.man}
\lstinputlisting[language=vim]{basic/vimrc}

\subsection{Default Code}
\manuallisting{basic/defaultCode.man}
\lstinputlisting{basic/defaultCode.cpp}

\subsection{Common Sense}
\manuallisting{basic/commonSense.man}

\subsection{Useful STL}
\lstinputlisting{basic/usefulSTL.cpp}

\subsection{Bi/Ternary Search}
\lstinputlisting{basic/BiTernarySearch.cpp}

\subsection{TroubleShoot}
\manuallisting{basic/troubleshoot.man}
...
\manuallisting{flow/MinCostFlow.man}
\lstinputlisting{flow/MinCostFlow.cpp}

\subsection{Dinic}
\manuallisting{flow/dinic.man}
...
\manuallisting{flow/FlowMethod.man}
% \lstinputlisting{flow/FlowMethod.txt}

\section{Math}

\subsection{Fast Pow \& Inverse \& Combination}
\manuallisting{math/fastPow_inverse_combination.man}
\lstinputlisting{math/fastPow_inverse_combination.cpp}
...
\lstinputlisting{math/linear_recurrence.cpp}

\subsection{Miller Rabin}
\manuallisting{math/Miller_Rabin.man}
...
\subsection{歐拉函數降冪公式}
\lstinputlisting{math/eular_function.cpp}

\subsection{貝爾數 Bell}
\lstinputlisting{math/bell_function.cpp}

\subsection{Result *}
\input{math/theorem.man}
...
\lstinputlisting{geometry/define.cpp}
...
\lstinputlisting{geometry/convex_hull_trick.cpp}

\subsection{掃描的線}
\lstinputlisting{geometry/scanline.cpp}

\subsection{Polar sort}
\lstinputlisting{geometry/polar_sort.cpp}
...
\lstinputlisting{dataStructure/li_chao_st.cpp}
...
\subsection{多邊形面積}
\lstinputlisting{geometry/polygon_area.cpp}
...
\manuallisting{graph/MinimumSteinerTree.man}
...
\subsection{差分約束 *}
\input{graph/system_of_difference_constraints.man}
...
\subsection{KMP}
\manuallisting{string/KMP.man}
\lstinputlisting{string/KMP.cpp}

\subsection{LCS \& LIS}
\manuallisting{string/LCS_LIS.man}
\lstinputlisting{string/LCS_LIS.cpp}
...
\subsection{Treap}
\manuallisting{dataStructure/treap.man}
\lstinputlisting{dataStructure/treap.cpp}

\subsection{BIT}
\manuallisting{dataStructure/Bit.man}
\lstinputlisting{dataStructure/BIT.cpp}

\subsection{二維偏序 *}
\lstinputlisting{dataStructure/2d_partial_order.cpp}

\subsection{三維偏序}
\lstinputlisting{dataStructure/cdq.cpp}

\subsection{持久化 *}
\lstinputlisting{dataStructure/persistent_seg.cpp}

\subsection{2D 線段樹}
\lstinputlisting{dataStructure/2d_seg.cpp}
...
\lstinputlisting{dataStructure/black_magic.cpp}

\section{DP}

\subsection{DP Method}
\manuallisting{dp/model.man}

\subsection{Bag Problem}
\lstinputlisting{DP/manyBag.cpp}

\subsection{Matrix}
\lstinputlisting{DP/matrix.cpp}
...
\lstinputlisting{others/mo_algorithm.cpp}
...
\begin{tikzpicture}
  \draw[step=1,black,thin] (0,0) grid (18,26);
\end{tikzpicture}
\clearpage
