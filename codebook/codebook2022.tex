...
\usepackage{titlesec}
\usepackage{amsmath}
\usepackage{environ}								%分開使用說明跟code
\usepackage{xparse}									%把begin/end env變成一行, https://tex.stackexchange.com/questions/223684/abridging-begin-end
...
\NewEnviron{manual}{} % hide manuals
\RenewEnviron{manual}{\BODY} % show manuals
